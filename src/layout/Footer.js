        ...
        <div className="footer py-4 text-center">
            <Row className="m-0">
                <Col xs={12} sm={12} className="py-2">
                    <a href="https://www.facebook.com"><i className="feather-facebook"/></a>
                    <a href="https://www.linkedin.com"><i className="feather-linkedin"/></a>
                    <a href="https://www.youtube.com"><i className="feather-youtube"/></a>
                    <a href="https://twitter.com"><i className="feather-twitter"/></a>
